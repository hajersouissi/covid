...
class PersonDetailScreen extends Component {
  ...
  render () {
    ...
    const onPersonDeleted = this.props.navigation.getParam (
      'personDeletedCallback'
    );
    ...
    return (
      <ScrollView>
        ...
        <View style={styles.container}>
                ...
                Alert.alert (
                  ...
                  [
                    {text: i18n.t ('personDetail:cancel')},
                    {
                      text: 'OK',
                      onPress: () => {
                        deletePerson (person, onPersonDeleted);
                      },
                    },
                  ],
                  {cancelable: false}
          ...
          <Image
            style={styles.image}
            source={person.image && {uri: person.image}}
          />
          <Text style={styles.headerText}>{person.name}</Text>
          <Text style={styles.testResultText}>
            {i18n.t ('personDetail:testResult')}{': '}{person.testResult}
          </Text>
